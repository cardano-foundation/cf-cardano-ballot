...
@RestController
@RequestMapping("/api/companies/drafts")
@RequiredArgsConstructor
public class CompanyCandidateDraftController {
    ...
    public ResponseEntity<CompanyCandidateResponseDto> publish(@PathVariable Long id, @RequestBody @Valid CompanyCandidateRequestDto dto) {
