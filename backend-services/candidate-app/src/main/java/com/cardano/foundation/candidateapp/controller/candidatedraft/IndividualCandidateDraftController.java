...
@RestController
@RequestMapping("/api/individuals/drafts")
@RequiredArgsConstructor
public class IndividualCandidateDraftController {
    ...
    public ResponseEntity<IndividualCandidateResponseDto> publish(@PathVariable Long id, @RequestBody @Valid IndividualCandidateRequestDto dto) {
