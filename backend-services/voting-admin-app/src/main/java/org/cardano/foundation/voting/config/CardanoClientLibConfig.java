...
public class CardanoClientLibConfig {
    ...
    @Bean
    public BackendService backendService(@Value("${cardano-client-lib.backend.type}") String ccliBackendType, @Value("${blockfrost.url}") String blockfrostUrl, @Value("${blockfrost.api.key}") String blockfrostApiKey) {
    ...
    public Account organiserAccount(CardanoNetwork cardanoNetwork, @Value("${organiser.account.mnemonic}" ) String organiserMnemonic) {
