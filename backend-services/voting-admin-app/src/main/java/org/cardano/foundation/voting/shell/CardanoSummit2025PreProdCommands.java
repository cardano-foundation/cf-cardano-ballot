...
public class CardanoSummit2025PreProdCommands {
    ...
    public String createCFSummit2025Event() {
        ...
        long startSlot = 100083600; // 21/08/2025 09:00:00
        long endSlot = 100785600; // 29/08/2025 12:00:00
        long proposalsRevealSlot = 100789200; // 29/08/2025 13:00:00

        var createEventCommand = CreateEventCommand.builder()
                .id(EVENT_NAME + "_" + "22BCC")
    ...
    @ShellMethod(key = "02_create-ambassador-category-pre-prod", value = "Create a CF-Summit 2025 Ambassador category on a PRE-PROD network.")
    @Order(2)
    public String createAmbassadorCategory(@ShellOption String event) {
        ...
        log.info("Creating CF-Summit 2025 Ambassador category on a PRE-PROD network...");
    ...
    @ShellMethod(key = "03_create-blockchain-for-good-category-pre-prod", value = "Create a CF-Summit 2025 Best Blockchain for Good category on a PRE-PROD network.")
    @Order(3)
    public String createBlockchainForGoodCategory(@ShellOption String event) {
        ...
        log.info("Creating CF-Summit 2025 Blockchain For Good category on a PRE-PROD network...");
    ...
    @ShellMethod(key = "04_create-innovation-standards-category-pre-prod", value = "Create a CF-Summit 2025 Innovation & Standards category on a PRE-PROD network.")
    @Order(4)
    public String createInnovationStandarsCategory(@ShellOption String event) {
        ...
        log.info("Creating CF-Summit 2025 Innovation & Standards category on a PRE-PROD network...");
    ...
    @ShellMethod(key = "05_create-dex-category-pre-prod", value = "Create a CF-Summit 2025 DEX category on a PRE-PROD network.")
    @Order(5)
    public String createDEXCategory(@ShellOption String event) {
        ...
        log.info("Creating CF-Summit 2025 Best DeFi / DEX category on a PRE-PROD network...");
    ...
    @ShellMethod(key = "06_create-developer-tooling-category-pre-prod", value = "Create a CF-Summit 2025 Developer & Tooling category on a PRE-PROD network.")
    @Order(6)
    public String createDeveloperToolingCategory(@ShellOption String event) {
        ...
        log.info("Creating CF-Summit 2025 Developer & Tooling category on a PRE-PROD network...");
    ...
    @ShellMethod(key = "07_create-educational-influencer-category-pre-prod", value = "Create a CF-Summit 2025 Educational Influencer category on a PRE-PROD network.")
    @Order(7)
    public String createEducationalInfluencerCategory(@ShellOption String event) {
        ...
        log.info("Creating CF-Summit 2025 Educational Influence category on a PRE-PROD network...");
    ...
    @ShellMethod(key = "08_create-nft-digital-collectibles-category-pre-prod", value = "Create a CF-Summit 2025 NFT & Digital Collectibles category on a PRE-PROD network.")
    @Order(8)
    public String createNFTDigitalCollectiblesCategory(@ShellOption String event) {
        ...
        log.info("Creating CF-Summit 2025 NFT & Digital Collectibles category on a PRE-PROD network...");
    ...
    @ShellMethod(key = "09_create-infrastructure-platform-category-pre-prod", value = "Create a CF-Summit 2025 Infrastructure Platform category on a PRE-PROD network.")
    @Order(9)
    ...
    @ShellMethod(key = "10_create-dao-tooling-governance-category-pre-prod", value = "Create a CF-Summit 2025 DAO Tooling & Governance category on a PRE-PROD network.")
    @Order(10)
    public String createDAOToolingGovernanceCategory(@ShellOption String event) {
        ...
        log.info("Creating CF-Summit 2025 DAO Tooling & Governance category on a PRE-PROD network...");
    ...
    @ShellMethod(key = "11_create-defi-platform-category-pre-prod", value = "Create a CF-Summit 2025 DeFi Platform category on a PRE-PROD network.")
    @Order(11)
    public String createDEFICategory(@ShellOption String event) {
        ...
        log.info("Creating CF-Summit 2025 DeFi Platform category on a PRE-PROD network...");
    ...
    @ShellMethod(key = "12_create-sspo-category-pre-prod", value = "Create a CF-Summit 2025 SSPO category on a PRE-PROD network.")
    @Order(12)
    public String createSSPOCategory(@ShellOption String event) {
        ...
        log.info("Creating CF-Summit 2025 SSPO category on a PRE-PROD network...");
