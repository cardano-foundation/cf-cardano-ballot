...
dependencies {
	...
	implementation("com.bloxbean.cardano:yaci-store-blocks-spring-boot-starter:0.0.11-beta3")
	implementation("com.bloxbean.cardano:yaci-store-transaction-spring-boot-starter:0.0.11-beta3")
