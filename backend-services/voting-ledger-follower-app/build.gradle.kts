...
dependencies {
	...
	implementation("com.bloxbean.cardano:cardano-client-backend-blockfrost:_")

	implementation("com.bloxbean.cardano:yaci-store-spring-boot-starter:_")
	implementation("com.bloxbean.cardano:yaci-store-blocks-spring-boot-starter:_")
	implementation("com.bloxbean.cardano:yaci-store-transaction-spring-boot-starter:_")
	implementation("com.bloxbean.cardano:yaci-store-metadata-spring-boot-starter:_")

	implementation("org.apache.commons:commons-lang3:_")

	implementation("io.blockfrost:blockfrost-java:_")
