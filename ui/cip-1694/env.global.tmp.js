...
window.env.REACT_APP_QUESTIONS = `$REACT_APP_QUESTIONS`;
window.env.REACT_APP_DISCORD_URL = `$REACT_APP_DISCORD_URL`;
window.env.REACT_APP_FAQ_URL = `$REACT_APP_FAQ_URL`;
window.env.REACT_APP_STATUS_PAGE_URL = `$REACT_APP_STATUS_PAGE_URL`;
window.env.REACT_APP_ENV_URI = `$REACT_APP_ENV_URI`;
