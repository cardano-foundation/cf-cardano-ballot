import { DEFAULT_CONTENT_TYPE_HEADERS, doRequest, METHODS } from '../handlers/httpHandler';
import {
...
const getEventById = async (eventId) => {
  return await doRequest(METHODS.GET, `${EVENT_BY_ID_REFERENCE_URL}/${eventId}`, {
...
const getVotingPower = async (eventId, stakeAddress) => {
  return await doRequest(METHODS.GET, `${VOTING_POWER_URL}/${eventId}/${stakeAddress}`, {
    ...DEFAULT_CONTENT_TYPE_HEADERS,
  });
};
