...
type EnvType = {
  ...
  GOOGLE_FORM_VOTE_ID_INPUT_NAME: string;
...
export const env: EnvType = {
  ...
  GOOGLE_FORM_VOTE_ID_INPUT_NAME:
    process.env.REACT_APP_GOOGLE_FORM_VOTE_ID_INPUT_NAME || get(window, 'env.REACT_APP_GOOGLE_FORM_VOTE_ID_INPUT_NAME'),
  // config vars
