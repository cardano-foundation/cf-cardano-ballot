...
import { Avatar, IconButton, List, ListItem, ListItemAvatar, ListItemSecondaryAction, Typography } from '@mui/material';
...
const CHROME_STORE_LINKS = {
  typhoncip30: 'https://chrome.google.com/webstore/detail/typhon-wallet/kfdniefadaanbjodldohaedphafoffoh',
  gerowallet: 'https://chrome.google.com/webstore/detail/gerowallet/bgpipimickeadkjlklgciifhnalhdjhe',
        ...
        {SUPPORTED_WALLETS.map((walletName, index) => (
          ...
          >
            ...
            <Typography className="walletLabel">
              ...
              <span className="walletName">{walletName === 'typhoncip30' ? 'typhon' : walletName}</span> Wallet
            </Typography>
            <ListItemSecondaryAction>
              <IconButton
                onClick={() => {
                  if (Object.keys(CHROME_STORE_LINKS).includes(walletName) && CHROME_STORE_LINKS[walletName].length) {
