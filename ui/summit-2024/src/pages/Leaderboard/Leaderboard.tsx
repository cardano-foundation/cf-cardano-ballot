...
const Leaderboard: React.FC = () => {
    ...
    const colors = [
        "#F8D6C3", "#F3B795", "#EE9868", "#E9793A", "#D85D18",
        "#AA4913", "#7C350E", "#4E2209", "#200E04"
    ];
                                ...
                                <Box sx={{
                                    ...
                                    <Box sx={{
                                        ...
                                        <Typography variant="h6" component="div" sx={{
                                            ...
                                            {selected !== undefined ? `${dataForChart[selected].value} Votes` : "1,000"}
                                        </Typography>
                                    </Box>
                                </Box>

                                <Box sx={{ display: "flex", mt: 2, maxWidth: "100%", flexWrap: "wrap" }}>
                                    {dataForChart.map((entry, index) => (
                                        <Box key={index} sx={{ display: "flex", alignItems: "center", px: "12px" }}>
                                            ...
                                            <Typography sx={{
                                                ...
                                                fontSize: "12px",
                                                marginTop: "8px",
                                            }}>{addressSlice(entry.title, 12, "end")}</Typography>
                                        </Box>
                                    ))}
                                </Box>
                            </Box>
