...
export interface CategoryResultsDatumConverter
  extends BasePlutusDataConverter {}
...
export interface FixedBlockchainDataStakePoolService
  extends BlockchainDataStakePoolService {}

export interface BackendServiceBlockchainDataChainTipService
  extends BlockchainDataChainTipService {}

export interface BackendServiceBlockchainDataCurrentStakePoolService
  extends BlockchainDataStakePoolService {}

export interface BackendServiceBlockchainDataStakePoolService
  extends BlockchainDataStakePoolService {}
