    ...
    sections: [
      {
        ...
        description:
          "You can do this by either clicking on the link at the top of the page labelled “Categories” or by clicking on the “Start Voting” button on the home page and directly below this section!",
      },
      {
        number: 2,
      ...
      },
      {
        ...
        description:
          "If you haven't connected or verified your wallet yet, you will be prompted to do so at this point. Follow the instructions from your chosen wallet.",
      },
      {
        number: 6,
